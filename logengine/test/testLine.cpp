...
void LogEngineLineTest::testLine1()
{
	...
	LogEvent event("MSG", lmError, 1, tp, 5, NULL);
...
void LogEngineLineTest::testLine11()
{
	...
	LogEvent event2("789", lmError, 1, tp, 5, NULL);
